...
const LoginForm = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="realtive max-w-md w-full">
        {/* Logo */}
      ...
      <button
        ...
        className="w-full flex items-center justify-center px-4 py-3 border border-gray-700 rounded-lg text-sm font-medium text-gray-300 bg-white/5 hover:bg-white/10 hover:border-gray-600 transition-all"
      >
