    ...
    jobs_data = [
        {
            ...
            'description': 'Разработка интерфейсов, интеграция с API, оптимизация...',
            'requirements': ['React/Vue 3+ года', 'TypeScript', 'Redux/Vuex'],
            'responsibilities': ['Разработка UI', 'Интеграция API', 'Код-ревью'],
            'benefits': ['ДМС', 'Удалёнка', 'Гибкий график'],
            'category': 'IT',
            ...
            'remote_work': True,
            'relocation': False,
            'skills': json.dumps(['React', 'Vue.js', 'TypeScript', 'Redux', 'Vuex'], ensure_ascii=False),
        ...
        },
        {
            ...
            'description': 'Обслуживание покупателей, работа с кассой, выкладка товара.',
            'requirements': ['Опыт в торговле желателен', 'Коммуникабельность'],
            'responsibilities': ['Консультирование', 'Работа с кассой'],
            'benefits': ['Соцпакет', 'Скидки', 'Официальное оформление'],
            'category': 'Продажи',
            'employment_type': 'full_time',
            ...
            'salary_period': 'month',
            'city': 'Алматы',
            'address': 'ТРЦ Mega Center',
            'remote_work': False,
            'relocation': False,
            'skills': json.dumps(['Продажи', 'Касса'], ensure_ascii=False),
            'languages': json.dumps([
                {'name': 'Казахский', 'level': 'fluent'},
        ...
        },
        {
            ...
            'description': 'Создание пользовательских интерфейсов, прототипов и макетов.',
            'requirements': ['Figma', 'Adobe XD', 'Опыт от 2 лет'],
            'responsibilities': ['Разработка макетов', 'Тестирование интерфейсов', 'Совместная работа с разработчиками'],
            'benefits': ['Гибкий график', 'Корпоративное обучение'],
            'category': 'Дизайн',
            'employment_type': 'full_time',
            'experience_level': 'middle',
            'salary_min': 500000,
            ...
            'remote_work': True,
            'relocation': False,
            'skills': json.dumps(['Figma', 'Adobe XD', 'UI/UX'], ensure_ascii=False),
            'languages': json.dumps([
                {'name': 'Русский', 'level': 'fluent'},
        ...
        },
        {
            ...
            'description': 'Ведение социальных сетей, создание контента, таргетированная реклама.',
            'requirements': ['Опыт работы от 1 года', 'Навыки копирайтинга', 'Photoshop/Canva'],
            'responsibilities': ['Создание постов', 'Аналитика соцсетей', 'Запуск рекламы'],
            'benefits': ['Бонусы за KPI', 'Корпоративные мероприятия'],
            'category': 'Маркетинг',
            ...
            'remote_work': True,
            'relocation': False,
            'skills': json.dumps(['SMM', 'Копирайтинг', 'Photoshop'], ensure_ascii=False),
            'languages': json.dumps([
                {'name': 'Казахский', 'level': 'fluent'},
                {'name': 'Русский', 'level': 'fluent'}
            ], ensure_ascii=False),
        ...
        {
            'title': 'Офис-менеджер',
            'description': 'Организация документооборота, приём звонков, работа с почтой.',
            'requirements': ['Владение ПК', 'Грамотная речь', 'Опыт работы от 1 года'],
            'responsibilities': ['Приём звонков', 'Организация встреч', 'Работа с документами'],
            'benefits': ['Соцпакет', 'Официальное трудоустройство'],
            ...
            'remote_work': False,
            'relocation': False,
            'skills': json.dumps(['Документооборот', 'Администрирование офиса'], ensure_ascii=False),
            'languages': json.dumps([
                {'name': 'Русский', 'level': 'fluent'},
                {'name': 'Казахский', 'level': 'intermediate'}
            ], ensure_ascii=False),
            'education_required': 'Высшее или среднее специальное',
            'company_id': companies[2].id,
            'posted_by': employers[2].id,
            'moderation_status': 'pending'
        }
